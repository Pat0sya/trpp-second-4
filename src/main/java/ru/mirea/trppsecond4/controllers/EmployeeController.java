package ru.mirea.trppsecond4.controllers;
import com.opencsv.bean.CsvToBeanBuilder;
import io.micronaut.http.HttpResponse;
import io.micronaut.http.annotation.Controller;
import io.micronaut.http.annotation.Get;

import ru.mirea.trppsecond4.entity.Organization;
...
public class EmployeeController {
    ...
    public EmployeeController() {
        organizationList = new CsvToBeanBuilder<Organization>(new InputStreamReader(this.
            getClass().getResourceAsStream("/MOCK_DATA.csv"))).withType(Organization.class).build().parse();
    }
